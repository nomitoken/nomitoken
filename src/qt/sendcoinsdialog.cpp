    ...
    model(0)
{
    ...
    ui->sendButton->setIcon(QIcon());
     ...
     ui->lineEditCoinControlChange->setPlaceholderText(tr("Enter a NOT address"));
#endif
...
void SendCoinsDialog::on_sendButton_clicked()
{
    ...
    {
        formatted.append(tr("<b>%1</b> to %2 (%3)").arg(BitcoinUnits::formatWithUnit(BitcoinUnits::NOT, rcp.amount), Qt::escape(rcp.label), rcp.address));
    }
...
//    WalletModel::SendCoinsReturn sendstatus = model->sendCoins(recipients);
    ...
    case WalletModel::AmountWithFeeExceedsBalance:
        QMessageBox::warning(this, tr("Send Coins"),
            ...
            arg(BitcoinUnits::formatWithUnit(BitcoinUnits::NOT, sendstatus.fee)),
            QMessageBox::Ok, QMessageBox::Ok);
        break;
     ...
     if (model)
     {
        ...
        if (text.isEmpty())
         ...
         else if (!CBitcoinAddress(text.toStdString()).IsValid())
         {
             ...
             ui->labelCoinControlChangeLabel->setText(tr("WARNING: Invalid NOT address"));
         }
         else
         {
