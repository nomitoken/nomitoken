...
int64 nChainStartTime = 1517573579;
...
const string strMessageMagic = "NOT Signed Message:\n";
...
bool CBlock::ConnectBlock(CTxDB& txdb, CBlockIndex* pindex, bool fJustCheck)
{
    ...
    bool fEnforceBIP30 = true; // Always active in NOT
    bool fStrictPayToScriptHash = true; // Always active in NOT
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "NOT", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "Created by nomi.pro,we like it,2018-02-02!";
        CTransaction txNew;
        ...
        block.nNonce   = !fTestNet ? 319240 : 309240;
		...
		block.print();
        assert(block.hashMerkleRoot == uint256("0xa14b992265d47cec405a73544fd9d2a9b872bec252c5d0d65d08005360e469e5"));
